...
function Hero() {
  return (
    <section className="pt-32 pb-20 px-6" style={{ background: C.ink }}>
...
function Methodology() {
  return (
    <section id="metodologia" className="py-28 px-6" style={{ background: C.ink }}>
      <div className="max-w-7xl mx-auto">
...
function FinalCTA() {
  return (
    <section className="py-32 px-6" style={{ background: C.surface, borderTop: `1px solid ${C.borderSubtle}` }}>
